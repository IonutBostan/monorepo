                ...
                <div className="mx-auto max-w-2xl lg:max-w-5xl">
                  <div className="max-w-2xl text-left">
                    ...
                    <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
                      The configuration of the Turborepo with the newest tools
                      in the ecosystem. Buid with vite, test with vitest, style
                      with tailwind, and deploy with Github Actions and Vercel.
                    </p>
